...
def main():
    minimizers_sequences_file_path = "lambda/lambda-sequences-minimizers.txt"  
    with open(minimizers_sequences_file_path, "r") as file:
        text_sequences = file.read()
    chunks_original = text_sequences.split("---")


    minimizers_reverseComplement_sequences_file_path = "lambda/lambda-sequences-reverseComplement-minimizers.txt"
    ...
    minimizers_file_path = "lambda/minimizers-lambda.txt"
    ...
    #print(len(chunks_reverseComplement))
    with open("lambda-mapping.txt", "w") as file:
        brojac = 0
